...
import supervisorRoutes from "./supervisor_routes";
  ...
  return (
    <Routes>
      ...
      {status === AuthStatus.AUTHENTICATED &&
        sessionType?.company_id === null &&
        sessionType.roles?.length === 0 &&
        chooseSessionRoute}
      {status === AuthStatus.AUTHENTICATED &&
        sessionType?.company_id === null &&
        ...
        generalRoutes}
      {sessionType?.roles?.includes(UserCompanyRole.SUPERADMIN) &&
        superadminRoutes}
