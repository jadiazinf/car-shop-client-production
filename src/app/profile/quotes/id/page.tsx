...
import { QuoteInfoForClientComponent } from "../../../../entities/quote/components/info/for_client";
    ...
    const response = await updateQuote(
      {
        ...
        status_by_client: Array.from(selectedOption)[0],
      } as QuoteModel,
      token!
    );
    ...
    <>
      ...
      <div className="w-full h-full">
        {!getQuoteResponse || !getQuoteResponse.data ? null : isGettingQuote ? (
          ...
          <div>
            <div className="mt-5">
              <QuoteInfoForClientComponent
                quote={getQuoteResponse.data}
                refetch={perform}
              />
            </div>
            {getQuoteResponse.data.status_by_client === QuoteStatus.PENDING && (
