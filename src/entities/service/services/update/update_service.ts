...
class UpdateServiceService {
  ...
  public async perform() {
    try {
      const response = await axios.patch<ServiceModel | { message: string }>(`${EnvironmentVariables.API_BASE_ROUTE}/api/${EnvironmentVariables.API_VERSION}/services/${this._service.id}?company_id=${this._company_id}`,
        {
