...
class GetCompanyImagesService {
  ...
  public async perform() {
    try {
      const response = await fetch(`${EnvironmentVariables.API_BASE_ROUTE}/api/${EnvironmentVariables.API_VERSION}/companies/${this._company_id}/download_company_images`, {
        method: 'GET',
        headers: {
