...
class GetLocationChildrensService {
  ...
  public async perform() {
    try {
      const response = await axios.get<ApplicationResponse<LocationModel[]>>(`${EnvironmentVariables.API_BASE_ROUTE}/api/${EnvironmentVariables.API_VERSION}/locations/${this._location_id}/location_childrens`,
      {
        headers: {
...
export default GetLocationChildrensService;
